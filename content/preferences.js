...
if (!this.PageObjectGenerator)
	this.PageObjectGenerator = {};

PageObjectGenerator.Preferences = {

	branch : Components.classes["@mozilla.org/preferences-service;1"]
			.getService(Components.interfaces.nsIPrefService)
			.getBranch("extensions.selenium-ide."),

	getString : function(name, defaultValue) {
		if (this.branch && this.branch.prefHasUserValue(name)) {
			return this.branch.getComplexValue(name,
	...
	setString : function(name, value) {
		...
		str.data = value;
		this.branch.setComplexValue(name,
...
PageObjectGenerator.Preferences.DEFAULT_OPTIONS = {
	DataFolder : "ProfD",
	ExportFolder : "Desk",
	UserFolder1 : null,
	UserFolder2 : null
	// ExportType : "pageobjects"
};
